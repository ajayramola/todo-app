...
import { trpc } from '../trpc'; // Note the '../' to go up one folder
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {isRegister && (
             <div>
                ...
                <input type="email" className="w-full bg-slate-950 border border-slate-800 text-white rounded-lg p-3 mt-1 focus:border-indigo-500 outline-none" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="name@example.com" />
             </div>
          )}
